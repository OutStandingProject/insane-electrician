        ...
        embeds = {
            {
                ...
                color = 0xFFA500,
                author = {
                    name = 'INSANE  Electrician - JOB FINISH',
                },
                thumbnail = {
                    url = data.avatar
                },
            ...
            if player.src == src then
                ...
                for _, remainingPlayer in ipairs(lobby.players) do
                    if remainingPlayer.src ~= src then
                        ...
                        TriggerClientEvent('insane-electrician:client:resetjob', remainingPlayer.src)
                        TriggerClientEvent('insane-electrician:client:sendNotification', remainingPlayer.src,
