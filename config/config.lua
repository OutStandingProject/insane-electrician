...
Config.Inventory             = "qs_inventory"        -- qb_inventory / esx_inventory / ox_inventory / qs_inventory / codem-inventory
Config.MoneyType             = "€"                   -- Money Type
Config.InteractionHandler    = 'drawtext'            --  qb-target, drawtext,ox-target
Config.ExampleProfilePicture = "https://r2.fivemanage.com"
Config.JobResetCommand       = "jobreset" -- Job Reset Command

Config.VehicleDeposit        = 500
...
Config.NotificationText      = {
    ...
    ['notEnoughDeposit'] = {
        text = "Não tens dinheiro suficiente para pagar a caução de %s€ pelo veículo.",
        type = "errorNotify"
    },
    ['depositPaid'] = {
        text = "Pagaste %s€ de caução do veículo, devolva-o depois em boas condições.",
        type = "infoNotify"
    },
    ['depositReturned'] = {
        text = "Recebeste o valor da caução do veículo.",
        type = "succesNotify"
    },
    ['notowner'] = {
